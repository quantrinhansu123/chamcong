    ...
    >
      ...
      <div className="bg-white shadow-xl shadow-primary-container/5 rounded-3xl p-6 flex items-center gap-5 border border-surface-container-highest relative overflow-hidden group">
        ...
        <div className="flex flex-col gap-1 min-w-0">
          <h2 className="text-xl font-bold text-primary truncate leading-tight">Nguyễn Văn An</h2>
          <p className="text-[13px] font-medium text-on-surface-variant/80 truncate">Sale | an.nguyen@jarviz.vn</p>
        </div>
      </div>
      ...
      {/* Logout */}
      <button className="flex items-center justify-center w-full py-4.5 px-6 rounded-2xl border border-red-200 text-red-600 bg-red-50/50 hover:bg-red-50 transition-all font-bold text-[15px] group active:scale-[0.98] mt-2 mb-10">
